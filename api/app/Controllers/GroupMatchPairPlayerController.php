...
class GroupMatchPairPlayerController extends BaseController
{
     ...
     * "parejas" y "jugadores" de los "grupos".
     */
    public function index(): void
    {
        ...
        $groupModel->paginate($queryParams['page'], self::LIMIT);
        ...
        $this->respondPagination($groups, $pagination, 'Information about all the groups matches and pairs players with pagination');
    }
