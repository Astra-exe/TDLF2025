...
export default function Awards() {
  return (
    <section className="mt-60" id="premios">
      <Container className="pt-12 pb-10 px-8 bg-gradient-to-b from-primary to-accent shadow-awards rounded-2xl max-w-screen-xl mx-auto">
        <hgroup className="text-center">
          <h3 className="text-6xl font-bold">Premios</h3>
          <p className="mt-5 text-xl leading-8 max-w-4xl mx-auto">
        ...
        <div className="mt-9 relative grid grid-cols-2 mx-auto max-w-screen-base gap-y-6 gap-x-5">
          <h4 className="col-span-full text-center text-3xl font-semibold">
            Categoria Libre
          </h4>
          <article className="relative flex items-center justify-center py-5 transition-all duration-500 border rounded-2xl group px-7 before:w-full before:h-full before:rounded-2xl before:backdrop-blur-md before:z-10 before:absolute before:inset-0 group bg-primary/30 border-accent">
            <span className="absolute text-nowrap w-full text-lg font-bold text-center text-white -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 max-w-[20ch] transition-all duration-500 z-[60] group-hover:translate-y-1/2">
          ...
          <h4 className="mt-8 col-span-full text-center text-3xl font-semibold">
            Categoria 50 y más
          </h4>
