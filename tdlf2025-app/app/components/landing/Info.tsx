        ...
        <div className="mt-9 flex justify-center gap-8">
          <article className="grid gap-5 border-2 px-8 py-16">
            <div className="inline-flex items-center gap-x-1.5">
              ...
              <span className="text-2xl">¿Cuándo?</span>
            </div>
            <h3 className="text-5xl">23 de Marzo 2025</h3>
            <span className="text-2xl">Domingo</span>
          </article>
          <article className="grid gap-5 border-2 px-8 py-16">
            <div className="inline-flex items-center gap-x-1.5">
              <svg
              ...
              <span className="text-2xl">¿Dónde?</span>
            </div>
            <h3 className="text-5xl">Deportiva Norte</h3>
            <a
              ...
              className="inline-flex gap-x-0.5 items-center text-2xl underline font-medium hover:opacity-80 transition-opacity group"
              target="_blank"
              rel="nofollow"
            >
